...
\newcommand{\pfun}[0]{\rightharpoonup}
...
\newcommand{\haskell}[2][1]{
  \lstinputlisting[language=Haskell,firstline=#1,escapechar=~]{#2}
}
\newcommand{\haskellpart}[3]{
\lstinputlisting[language=Haskell,firstline=#2,lastline=#3]{#1}
}
}
{}
\makeatother
